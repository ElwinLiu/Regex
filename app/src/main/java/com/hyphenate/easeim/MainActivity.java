...
import com.hyphenate.easeim.section.match.fragment.MatchFragment;
...
import com.hyphenate.easeim.section.moment.MomentFragment;
...
public class MainActivity extends BaseInitActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private EaseBaseFragment mMatchFragment, mMomentFragment, mConversationListFragment, mFriendsFragment, mAboutMeFragment;
    private EaseBaseFragment mCurrentFragment;
    private TextView mTvMainDiscoverMsg, mTvMainMomentMsg, mTvMainHomeMsg, mTvMainFriendsMsg, mTvMainAboutMeMsg;
    private int[] badgeIds = {R.layout.demo_badge_discover, R.layout.demo_badge_moment, R.layout.demo_badge_home, R.layout.demo_badge_friends, R.layout.demo_badge_about_me};

    private int[] msgIds = {R.id.tv_main_discover_msg, R.id.tv_main_moment_msg, R.id.tv_main_home_msg, R.id.tv_main_friends_msg, R.id.tv_main_about_me_msg};
...
//        switchToHome();
        ...
        for(int i = 0; i < childCount; i++) {
            ...
            switch (i) {
                case 0 :
                    ...
                    break;
                case 1 :
                    mTvMainMomentMsg = badge.findViewById(msgIds[1]);
                    break;
                case 2 :
                    mTvMainHomeMsg = badge.findViewById(msgIds[2]);
                    break;
                case 3 :
                    mTvMainFriendsMsg = badge.findViewById(msgIds[3]);
                    break;

                case 4 :
                    mTvMainAboutMeMsg = badge.findViewById(msgIds[4]);
                    break;
            }
    ...
    private void switchToDiscover() {
        ...
        replace(mMatchFragment, "discover");
    }
    ...
    private void switchToMoment() {
        ...
        replace(mMomentFragment, "moment");
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.em_main_nav_moment:
                switchToMoment();
                mTitleBar.setTitle(getResources().getString(R.string.em_main_title_moment));
                showNavigation = true;
                break;
