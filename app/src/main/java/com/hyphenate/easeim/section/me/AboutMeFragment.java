...
import com.hyphenate.easeim.section.me.PersonalPage.PersonalPageActivity;
...
//    private ArrowItemView itemDeveloperSet;
    private ArrowItemView itemPersonalMoment;
...
//        itemDeveloperSet = findViewById(R.id.item_developer_set);
        itemPersonalMoment = findViewById(R.id.item_personal_moment);
...
//        itemDeveloperSet.setOnClickListener(this);
        itemPersonalMoment.setOnClickListener(this);
    }
...
//                break;
            case R.id.item_personal_moment:
                PersonalPageActivity.actionStart(mContext); // 跳转到个人动态列表
//                OthersPageActivity.actionStart(mContext, 31);
                break;
        }
    }
